...
const featuredProjects = [
  {
    ...
    icon: ImageIcon,
    description:
      "An end-to-end hybrid image enhancement and restoration pipeline orchestrating deep learning models and classical computer vision for blind deblurring, super-resolution, and facial feature reconstruction.",
    details:
      "Combines Real-ESRGAN, GFPGAN, and Restormer with custom OpenCV modules for radial distortion correction, skin smoothing, and color preservation. Backed by asynchronous FastAPI endpoints with memory-aware tiled GPU inference and a React/TypeScript interface.",
    technologies: [
      "Python",
      "FastAPI",
      "React.js",
    ...
    highlights: [
      "Deep learning pipeline with Real-ESRGAN, GFPGAN & Restormer for 2x/4x super-resolution & facial reconstruction",
      "Custom OpenCV & NumPy modules for lens distortion correction, zoom artifact recovery & skin smoothing",
      "Asynchronous FastAPI backend with memory-aware tiled GPU inference to eliminate OOM errors",
      "React.js & TypeScript UI with real-time before/after comparison slider & dynamic export controls",
      "Privacy-first local execution architecture with JPEG metadata preservation & error boundaries",
    ],
    repoUrl: "",
    liveUrl: "",
  },
  {
    title: "My Academia",
    category: "AI-Powered Academic System",
    status: "Completed",
    statusTone: "emerald",
    icon: BookOpen,
    description:
      "An AI-powered academic assistant and tracking system leveraging Retrieval-Augmented Generation (RAG) for contextual question answering, automated quiz generation, and module progress monitoring.",
    details:
      "Engineered an end-to-end document ingestion pipeline using PyMuPDF and ChromaDB for vector storage and semantic search with citations. Built a full-stack React and Express platform, containerized with Docker and automated via Jenkins CI/CD.",
    technologies: [
      "Python",
      "FastAPI",
      "React.js",
    ...
    highlights: [
      "RAG assistant integrating FastAPI, Google Gemini API & Sentence-Transformers for Q&A & automated quizzes",
      "Document ingestion pipeline with PyMuPDF chunking & ChromaDB vector similarity search with citations",
      "Full-stack web application for authentication, module management & academic progress tracking",
      "Containerized microservices using Docker with automated Jenkins CI/CD deployment pipelines",
      "Self-hosted Ubuntu Linux server deployment with secure tunneling for high availability",
    ],
...
const additionalProjects = [
  {
    title: "Classroom Engagement Monitoring",
    subtitle: "AI & Computer Vision Attention Estimation",
    category: "AI & Computer Vision",
    status: "Completed",
    statusTone: "emerald",
    icon: Eye,
    description:
      "An exploratory computer vision system designed to analyze student engagement and attention metrics in educational environments using facial landmark detection.",
    technologies: [
      "Python",
      "Streamlit",
      "OpenCV",
    ...
    contributions: [
      "Built an exploratory computer vision system to analyze student engagement using facial landmark detection techniques.",
      "Implemented attention estimation using Eye Aspect Ratio (EAR) and head pose concepts with OpenCV and dlib.",
      "Developed a Streamlit interface to visualize live video feeds and engagement-related metrics in real time.",
    ],
    repoUrl: "",
    liveUrl: "",
  },
  {
    title: "BudgetBuddy",
    subtitle: "DevOps Implementation (Hands-on Learning Project)",
    category: "DevOps & Cloud",
    status: "Completed",
    statusTone: "emerald",
    icon: Wallet,
    description:
      "A full-stack budget management application deployed to gain hands-on experience with DevOps practices, CI/CD pipelines, Infrastructure as Code, and production monitoring.",
    technologies: [
      "React",
      "Node.js",
      "Express.js",
    ...
    contributions: [
      "Implemented a Jenkins CI/CD pipeline triggered by GitHub webhooks to automate build, containerization, and AWS EC2 deployments.",
      "Provisioned infrastructure using Terraform and automated configuration management using Ansible.",
      "Integrated Grafana, Prometheus, and application health-check workflows to improve deployment observability.",
      "Utilized Docker and Docker Compose to containerize services and reduce manual deployment effort.",
    ],
  ...
  {
    title: "MOH Connect",
    subtitle: "Maternal & Child Care Management System (Group Project)",
    category: "Frontend Development",
    status: "In Progress",
    statusTone: "blue",
    icon: HeartPulse,
    description:
      "A role-based healthcare management system designed to support maternal and child healthcare services through a centralized digital platform.",
    technologies: [
      "React.js",
      "JavaScript",
      "React Router",
    ...
    contributions: [
      "Contributing as a frontend developer in a group project building a role-based healthcare management platform.",
      "Developing responsive UI components and collaborating with team members to integrate backend REST APIs.",
      "Supporting role-based authentication and healthcare workflow interfaces.",
    ],
